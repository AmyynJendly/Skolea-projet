...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $errors = (new UtilisateurController())->modifierParAdmin($id, $data);
...
<div class="card" style="max-width:640px;">
    <div class="card-body">
        <form method="post" action="admin_utilisateur_modifier.php?id=<?= $id ?>" id="form-utilisateur-modifier" novalidate>
